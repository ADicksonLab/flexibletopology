...
FIELDS = ['time', 'nn_forces', 'nn_potentialEnergy', 'nn_velosities',
          'nn_coordinates']
...
class NNForceReporter(object):
    ...
    def _initialize(self, simulation):
        ...
        if self._velosities:
            self.h5.create_dataset('nn_velosities', (0, 0, 0), maxshape=(None, MAX_ATOM_NUMS, 3))
    ...
    def report(self, simulation, state):
        ...
        if self._velosities:
            ...
            self._extend_traj_field('nn_velosities', velocities)
